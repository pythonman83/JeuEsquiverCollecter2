...
fin_jeu_music_path = 'fin_jeu.ogg'
...
player_image_path = 'image_joueur4.png'
player_image = pygame.image.load(player_image_path).convert_alpha()
player_image = pygame.transform.scale(player_image, (70, 70))

# Charger les images des obstacles pour chaque niveau
obstacle_images = [
    pygame.image.load('image_obstacle_niveau1.png').convert_alpha(),
    pygame.image.load('image_obstacle_niveau2.png').convert_alpha(),
    pygame.image.load('image_obstacle_niveau3.png').convert_alpha(),
    pygame.image.load('image_obstacle_niveau4.png').convert_alpha()
]

aid_image_path = 'image_aide.png'
...
background_images = [
    pygame.image.load('background_niveau1.png').convert(),
    pygame.image.load('background_niveau2.png').convert(),
    pygame.image.load('background_niveau3.png').convert(),
    pygame.image.load('background_niveau4.png').convert()
]

# Charger l'image de fin de jeu et la redimensionner
end_game_image_path = 'end_game_image.png'
